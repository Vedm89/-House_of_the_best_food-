(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".comment-page__slider")) new core(".comment-page__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".cookers__slider")) new core(".cookers__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
